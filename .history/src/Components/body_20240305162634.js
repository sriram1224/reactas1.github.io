...
function final(){
    return(
        <div className='para'>
        <p className="p1">
        Are you looking for a professional,regestered massage theraphist?Sample Theraphy massage has 4 registered massage Theraphysts who can provide physical 
        </p>
        </div>
    )
}
