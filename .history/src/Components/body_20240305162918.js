...
function final(){
    return(
        ...
        <p>
        we are committed to your long term health and well-being. our multi-displinary clinic provides a balanced approach to a healthy lifestyle. Enhance your health and improve your perfomance with 
        </p>
        </div>
    )
}
